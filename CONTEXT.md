...
- **152 tickets done. Latest (2026-09-20, user sign-off): R-67** — Wi-Fi access modal verified. Previous (2026-09-18): R-66 (R-52 interim: hide Buying templates UI, FE only, reversible).
- **SemVer baseline took effect (2026-09-18)** — **v1.0.0** tagged on `main` (annotated `2c48ad6`), **v1.1.0** tagged on `main` (`6fb1219`). First GitHub Release published at `https://github.com/rider4585/IMPOC/releases/tag/v1.0.0`. `gh` 2.101.0 installed at `/opt/homebrew/bin/gh`. Docs-only changes → no bump.
