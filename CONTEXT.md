...
- **Tests:** frontend `npx vitest run` (420 passing); backend `NODE_ENV=test NODE_OPTIONS=--experimental-vm-modules npx jest --forceExit` (753 passing).
