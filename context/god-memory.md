...
- CONTEXT.md + CONTEXT-RESUME.md refreshed (150 done; R-64 bullet; tasks.json single-file note). Committed on context + pushed. Local main fast-forwarded to origin/main (was 1 behind, R-64). No app-code changes outstanding.
