...
- **Tests:** frontend `npx vitest run` (413 passing); backend `NODE_ENV=test NODE_OPTIONS=--experimental-vm-modules npx jest --forceExit` (749 passing).
