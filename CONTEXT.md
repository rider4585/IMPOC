...
- **Tests:** frontend `npx vitest run` (436 passing); backend `NODE_ENV=test NODE_OPTIONS=--experimental-vm-modules npx jest --forceExit` (769 passing).
...
- **Open (planned, not started):**
  ...
  - **R-46 Instagram publishing** (narrowed; WhatsApp part moved into R-62) — needs Meta accounts + app review; parked.
  - **R-47** closed 2026-09-14 as folded into R-62e.
