...
- **Tests:** frontend `npx vitest run` (395 passing); backend `NODE_ENV=test NODE_OPTIONS=--experimental-vm-modules npx jest --forceExit` (744 passing).
