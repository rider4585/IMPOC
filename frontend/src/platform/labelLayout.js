/**
 * Pure label-sheet geometry (R-50). Mirror of
 * backend/src/modules/barcode-layouts/barcode-layout.geometry.js — keep both in sync.
 * The live preview on the Label layout screen runs this exact math.
 *
