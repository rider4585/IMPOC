...
- **Parked by user (revisit ~2026-10-13):** **R-52** — hide / remove / keep the Buying templates module, after a month of production use. Interim (2026-09-18): the templates UI is hidden FE-only (R-66, shipped, awaiting user sign-off) — functionality, backend and data fully intact for a later keep/restore decision.
